...
/**
 * Entropy — left half ordered grid, right half chaotic particles, the two
 * influence each other across the boundary. The visual metaphor for what
 * Hermes does: bring calm structure to scattered work.
 */
export function Entropy({ className = "", size = 320 }: EntropyProps) {
